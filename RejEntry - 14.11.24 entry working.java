...
static JTextField tb_rej_en_id, tbrejqty;
...
//Rej Entry id
		JLabel  lblrejenid = new JLabel("Forging Entry ID");
...
//Combo Heat Code 
		...
		ActionListener partlistco = new ActionListener()
			...
			public void actionPerformed(ActionEvent e)
				{
				cbhtcode = (JComboBox) e.getSource();	
				HeatCode= Integer.parseInt((String)cbhtcode.getSelectedItem());
				}

			};

		cbhtcode.addActionListener(partlistco);
		...
		btnAdd.addActionListener(new ActionListener()
			...
			public void actionPerformed(ActionEvent e)
				...
				try
					...
					String queryadd="Insert into entry_rej (RejArea_ID, RejEntry_Date, Part_ID, Defect_ID, Rej_Qty, HeatID) Values (?, ?, ?, ?, ?, ?)";
