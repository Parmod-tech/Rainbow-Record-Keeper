...
//Find Data----------------------------------------
		...
		public void actionPerformed(ActionEvent e)
			...
			int idnum=Integer.parseInt(ttx);
				...
				while(rs.next())
				{
				//System.out.println("ID is "+(Integer.toString(rs.getInt(1))));
				//java.sql.Date sdt1=(java.sql.Date) rs.getDate(1);
				//long ldt=sdt1.getTime();
				//java.util.Date retriveddt= new java.util.Date(ldt);
				//System.out.println("millisec" +ldt);
				//System.out.println("Date is "+rs.getString(2));
