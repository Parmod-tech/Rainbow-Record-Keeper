...
//static JComboBox<String> ComboHeat;
...
/*
//Button Open Heat Form
		JButton btnHeatForm = new JButton("Heat Form");
		panel2.add(btnHeatForm);	
		btnHeatForm.addActionListener(new ActionListener()
			{
			@Override
			public void actionPerformed(ActionEvent e)
				{	
		...
		public void actionPerformed(ActionEvent e)
			{
				...
				textheatcode.setText(Integer.toString(rs.getInt(7)));
				
				java.sql.Date fdt1=(java.sql.Date) rs.getDate(9);
				long ldt=fdt1.getTime();
				java.util.Date retriveddt= new java.util.Date(ldt);
				fdate.setValue(retriveddt);
				
								
				combopress.setSelectedItem(rs.getString(10));
				textfshift.setText(rs.getString(3));
				textfshifthrs.setText(Integer.toString(rs.getInt(5)));
				combopart.setSelectedItem(rs.getString(11));

				textfqty.setText(Integer.toString(rs.getInt(8)));
